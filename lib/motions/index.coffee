...
{Search, SearchCurrentWord, BracketMatchingMotion, BracketSearchingMotion, RepeatSearch} = require './search-motion'
...
Motions.BracketSearchingMotion = BracketSearchingMotion
